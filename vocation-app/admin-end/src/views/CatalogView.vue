<template>
  <TopBar title="Manage Vacation Pacakges"/>
  <div class="p-col-12">
    <h1>Manage Vacation Package</h1>
  </div>
  <div class="p-col-12">
    ...
    <Dialog header="Add Vacation Package" v-model:visible="displayCatalog">
      <CatalogForm @catalog-form-close="displayCatalog = false; getCatalog();"/>
    </Dialog>
  </div>
  <div class="p-col-12">
    <Card v-for="c of catalog" :key="c.id">
      <template #header>
        <img :alt="c.description" :src="c.image_rul" />        
      </template>
